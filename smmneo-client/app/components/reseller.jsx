  ...
  return (
    <section className="py-12 sm:py-16 bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a
          href="#"
          className="mt-8 inline-flex rounded-full bg-white px-7 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-white/20 transition hover:bg-slate-100"
        >
          Join Now As Resellers
        </a>
      </div>
    </section>
  );
