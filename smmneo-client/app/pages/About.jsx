...
const PersonCard = ({ bg, emoji, icon }) => (
  <div className={`relative rounded-[2rem] p-2 flex items-end justify-center shadow-xl overflow-hidden`} style={{ background: bg, width: 160, height: 180 }}>
    <div className="text-6xl mb-2">{emoji}</div>
    <div className="absolute top-3 right-3 text-2xl">{icon}</div>
  </div>
);
...
const About = () => {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-slate-600 max-w-xl">
                We build fast, reliable social media marketing tools that help creators and agencies grow.
                Our journey began with a vision to democratize social media marketing, making it accessible
      ...
      <main className="mx-auto max-w-7xl px-6 py-20 lg:px-8 space-y-28">

        {/* Mission – image left */}
        <section className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="flex justify-center order-2 lg:order-1">
            <div className="relative">
              <div className="absolute inset-0 -rotate-6 rounded-[3rem] bg-indigo-600 opacity-90"></div>
              <div className="relative rounded-[2.5rem] bg-gradient-to-br from-indigo-100 to-purple-100 w-64 h-64 flex items-end justify-center overflow-hidden shadow-xl">
                <span className="text-8xl mb-4 select-none">👩</span>
                <div className="absolute top-4 right-4 text-3xl">💬</div>
                <div className="absolute bottom-10 left-4 text-3xl">🛍️</div>
                <div className="absolute top-10 left-6 text-2xl">▶️</div>
              </div>
            </div>
          </div>
          <div className="order-1 lg:order-2">
            <span className="text-xs font-bold text-indigo-600 uppercase tracking-widest">Mission</span>
            <h2 className="mt-2 text-3xl font-extrabold text-slate-900 leading-snug">
              Empowering Businesses with Affordable Social Media Strategies
            </h2>
            <p className="mt-4 text-slate-600 leading-relaxed">
              Our mission is straightforward—to provide high-quality, cost-effective social media services
              that drive business growth and enhance online visibility. We are committed to helping businesses
              and beyond unlock their full potential on social media platforms.
            </p>
            <button className="mt-6 rounded-full bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-indigo-500 transition">
              Learn More
            </button>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div>
            <span className="text-xs font-bold text-indigo-600 uppercase tracking-widest">Vision</span>
            <h2 className="mt-2 text-3xl font-extrabold text-slate-900 leading-snug">
              Shaping the Future of Digital Marketing
            </h2>
            <p className="mt-4 text-slate-600 leading-relaxed">
              Our vision extends beyond just being a service provider: we aim to be the harbinger of innovation
              in social media marketing, constantly adapting to the ever-changing digital landscape. We envision
              a world where every business, regardless of its size, has equal opportunity to thrive.
            </p>
            <button className="mt-6 rounded-full bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-indigo-500 transition">
              Get Started
            </button>
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="relative rounded-[2.5rem] bg-gradient-to-br from-purple-100 to-orange-100 w-64 h-64 flex items-end justify-center overflow-hidden shadow-xl">
                ...
                <div className="absolute top-10 left-6 text-2xl">🪙</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 -rotate-6 rounded-[3rem] bg-violet-600 opacity-80"></div>
              <div className="relative rounded-[2.5rem] bg-gradient-to-br from-violet-100 to-blue-100 w-64 h-64 flex items-end justify-center overflow-hidden shadow-xl">
                <span className="text-8xl mb-4 select-none">👩‍💼</span>
                <div className="absolute top-4 right-4 text-3xl">🚀</div>
              </div>
            </div>
          ...
          <div>
            <span className="text-xs font-bold text-indigo-600 uppercase tracking-widest">Our Team</span>
            <h2 className="mt-2 text-3xl font-extrabold text-slate-900 leading-snug">
      ...
      <section className="bg-slate-950 py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <span className="text-xs font-medium text-orange-400 uppercase tracking-widest">Get In Touch</span>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            <div>
              <span className="text-xs font-bold text-indigo-600 uppercase tracking-widest">Why We Are Different from Others</span>
              <h2 className="mt-3 text-3xl font-extrabold text-slate-900 leading-snug">
              ...
              <p className="mt-4 text-slate-600 leading-relaxed text-sm">
                ...
                integrity, and results, making us not just a service provider but a trusted partner in our clients'
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 rotate-3 rounded-[3rem] bg-indigo-600 opacity-80"></div>
                <div className="relative rounded-[2.5rem] bg-gradient-to-br from-indigo-100 to-blue-100 w-64 h-64 flex items-end justify-center overflow-hidden shadow-xl">
                  <span className="text-8xl mb-4 select-none">👩</span>
